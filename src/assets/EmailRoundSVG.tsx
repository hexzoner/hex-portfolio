export default function EmailRoundSVG() {
  return (
    <svg className="fill-primary cf-icon-svg size-7" width="24px" height="24px" viewBox="-1 0 19 19" xmlns="http://www.w3.org/2000/svg">
